...
namespace WinAppRegularPolygons
{
    ...
    {
        private CEneagon ObjEneagon = new CEneagon();
        public frmEneagon()
        {
            InitializeComponent();
        ...
        {
            Boolean flag;
            flag = ObjEneagon.ReadData(txtSide, txtPerimeter, txtArea, picCanvas);
            if (flag)
            {
                ObjEneagon.PerimeterEneagon();
                ObjEneagon.AreaEneagono();
                ObjEneagon.PrintData(txtSide,txtPerimeter, txtArea);
